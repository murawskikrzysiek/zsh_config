# Generated by Powerlevel10k configuration wizard on 2025-07-29 at 14:06 CEST.
...
() {
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      # Styling for up-to-date Git status. Defaults below; theme files in
      # themes/ override via the P10K_GIT_*_COLOR variables.
      local       meta="%F{${P10K_GIT_META_COLOR:-248}}"        # grey foreground
